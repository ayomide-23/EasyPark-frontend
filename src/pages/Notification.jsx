...
const Notifications = () => {
  ...
  const fetchNotifications = () => {
    ...
    if (!token) return;
    fetch('https://easypark.atwebpages.com/fetch_notifications.php', {
  ...
  const handleMarkAsRead = async (id) => {
    try {
      await fetch('https://easypark.atwebpages.com/mark_notifications.php', {
        method: 'POST',
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await fetch('https://easypark.atwebpages.com/delete_notification.php', {
        method: 'POST',
        headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
        body: new URLSearchParams({ id }),
      });
